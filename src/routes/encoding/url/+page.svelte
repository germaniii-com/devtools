<script>
	...
	const sampleText = `Hello, World! ñ ü 你好 ?foo=bar&baz=qux#anchor`;
	...
	function decode() {
		error = '';
		if (!rightText.trim()) {
			error = 'Please enter URL-encoded text to decode.';
			return;
		}
		try {
...
<div class="converter-container">
	<div class="tool-header">
		...
		<p class="tool-description">Encode text for use in URLs or decode URL-encoded strings.</p>
	</div>
